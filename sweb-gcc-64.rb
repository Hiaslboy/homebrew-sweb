class SwebGcc < Formula
  ...
  bottle do
    ...
    sha256 "275f8a4bca197cbc6fe2a54618c7fe15a22733c0e04c27e2d631a779ca45b527" => :el_capitan
  end
  ...
  def install
    ...
    ln_s("#{Formula["sweb-binutils"].opt_prefix}/x86_64-linux-gnu", "#{prefix}/x86_64-linux-gnu")
